    ...
    <header className="bg-primary text-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a
            href="#"
            className="flex items-center gap-1 hover:text-accent-secondary transition-colors"
          >
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            className="hidden md:flex items-center gap-2 hover:bg-blue-800 hover:text-white"
          >
          ...
          <Button
            variant="outline"
            className="bg-white text-primary hover:bg-accent hover:text-white border-none"
          >
            Sign In
          </Button>
          <Button
